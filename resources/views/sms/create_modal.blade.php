            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-6 mb-5 myclass">
                        ...
                        {{ Form::tel('phone', null, ['class' => getCurrentLoginUserLanguageName() == 'ar' ? 'form-control text-end' : 'form-control iti phoneNumber', 'required','id' => 'smsPhoneNumber', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
