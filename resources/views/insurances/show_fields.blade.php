                    ...
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
                                ...
                                <span class="fs-5 text-gray-800">{{ isset($insurance->discount) ? $insurance->discount.'%': __('messages.common.n/a')}}</span>
                            </div>
                            <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
                            ...
                            <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
                                ...
                                <span
                                        class="fs-5 text-gray-800">{!! !empty($insurance->remark) ? nl2br(e($insurance->remark)): __('messages.common.n/a')  !!}</span>
                            </div>
                            <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
                                <label
