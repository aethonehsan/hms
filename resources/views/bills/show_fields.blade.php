<div class="d-flex align-items-center pb-10">
    ...
    <a target="_blank" href="{{ route('bills.pdf', ['bill' => $bill->id]) }}"
        class="btn btn-success  {{ getLoggedInUser()->language == 'ar' ? 'me-auto' : 'ms-auto' }} text-white">{{ __('messages.bill.print_bill') }}</a>
</div>
<div class="m-0">
    ...
    <div class="row g-5 mb-11">
        <div class="col-sm-3">
            ...
            <div class="fs-5 text-gray-800">
                {{ !empty($bill->patient->patientUser->phone) ? $bill->patient->patientUser->region_code . $bill->patient->patientUser->phone : __('messages.common.n/a') }}
            </div>
        </div>
        <div class="col-sm-3">
    ...
    <div class="row g-5 mb-11">
        <div class="col-sm-3">
            ...
            <div class="fs-5 text-gray-800">
                {{ \Carbon\Carbon::parse($bill->patientAdmission->admission_date)->translatedFormat('jS M, Y g:i A') }}
            </div>
        </div>
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
            ...
            <div class="fs-5 text-gray-800">
                {{ !empty($bill->patientAdmission->package->name) ? $bill->patientAdmission->package->name : 'N/A' }}</div>
        </div>
        <div class="col-sm-3">
