<div class="row">
    ...
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        ...
        <div class="d-flex align-items-center mt-3">
            <div class="form-check mb-0 {{getLoggedInUser()->language == 'ar' ? 'ms-10' : 'me-10'}}">
...
<div class="com-sm-12">
    <div class="col-lg-12 col-md-12 col-sm-12 d-flex justify-content-end mb-4">
        <button type="button" class="btn btn-primary text-star" id="addBillItem">
            {{ __('messages.invoice.add') }}</button>
    </div>
    <div class="table-responsive-sm">
        <table class="table table-striped" id="billTbl">
            <thead>
                <tr class="{{getLoggedInUser()->language=='ar'?'text-end':'text-start'}} text-muted fw-bolder fs-7 text-uppercase gs-0">
            ...
            <tbody class="bill-item-footer">
                <tr>
                    ...
                    <td class="text-right"><b>{{ getCurrencySymbol() }}</b>
                        <span id="totalPrice"
                            class="price">{{ isset($bill) ? number_format($bill->amount, 2) : 0 }}</span>
                    </td>
                </tr>
            </tbody>
        </table>
