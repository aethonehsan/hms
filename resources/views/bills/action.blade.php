<div class="d-flex align-items-center ">
    <a href="{{ route('bills.pdf', ['bill' => $row->id]) }}" title="<?php echo __('messages.bill.print_bill'); ?>" class="btn px-1 text-warning fs-3"
        target="_blank">
    ...
    <a href="javascript:void(0)" title="<?php echo __('messages.common.delete'); ?>" data-id="{{ $row->id }}"
        class="bill-delete-btn  btn px-1 text-danger fs-3 pe-0 {{ getLoggedInUser()->language == 'ar' ? 'me-2' : '' }}"
        wire:key="{{ $row->id }}">
