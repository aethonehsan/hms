<div class="d-sm-flex align-items-sm-center mb-lg-10 mb-7">
    <div class="d-flex align-items-center me-sm-7 mb-sm-0 mb-4">
        ...
        <label
            class="text-gray-600 fs-5  {{ getLoggedInUser()->language == 'ar' ? 'me-5 ms-5' : 'ms-5' }}">{{ __('messages.bed_status.assigned_beds') }}</label>
    </div>
    <div class="d-flex align-items-center">
        <i class="fas fa-bed fs-1 text-success"></i>
        <label
            class="text-gray-600 fs-5 {{ getLoggedInUser()->language == 'ar' ? 'me-5' : 'ms-5' }}">{{ __('messages.bed_status.available_beds') }}</label>
    </div>
</div>
<div>
                                    ...
                                    <div class="row">
                                        ...
                                        @else
                                            <div class="no-bed-available">
                                                <span
                                                    class="fs-6 text-gray-800er fs-7">{{ __('messages.common.no') . ' ' . __('messages.bed_assign.bed') . ' ' . __('messages.bed.available') }}</span>
                                            </div>
                                        @endif
                                    </div>
                                </div>
