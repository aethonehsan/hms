            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="form-group mb-5">
                    ...
                    @elseif($patientDiagnosisTest->property_name == 'weight')
                        {{ Form::text($patientDiagnosisTest->property_name, $patientDiagnosisTest->property_value, ['class' => 'form-control', 'max' => '200', 'min' => '1' , 'step' => '.01', 'data-mask'=>'##0,00', 'placeholder' => __('messages.patient_diagnosis_test.weight')]) }}
