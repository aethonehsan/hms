<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('charge_id', __('messages.delete.charge').':',  ['class' => 'form-label']) }}
            <span class="required"></span>
            {{ Form::select('charge_id',[], null, ['class' => 'form-select charge-code','required','disabled','id' => 'chargeCode','placeholder'=>__('messages.new_change.select_charge'),'required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
