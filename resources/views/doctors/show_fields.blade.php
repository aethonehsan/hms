            ...
            <div class="col-xxl-5 col-12">
                <div class="d-sm-flex align-items-center mb-5 mb-xxl-0 text-center text-sm-start">
                    ...
                    <div class="ms-0 ms-sm-10 mt-5 mt-sm-0">
                        <span
                            class="badge bg-light-{{ $doctorData->doctorUser->status === 1 ? 'success' : 'danger' }} mb-2">{{ $doctorData->doctorUser->status === 1 ? __('messages.common.active') : __('messages.common.de_active') }}</span>
                        <h2><a href="#" class="text-decoration-none">{{ $doctorData->doctorUser->full_name }}</a>
                        </h2>
...
<div class="mt-7 overflow-hidden">
    <ul class="nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap" id="myTab" role="tablist">
        ...
        <li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0" id="cases-tab" data-bs-toggle="tab" data-bs-target="#dcases" type="button"
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            ...
                            <span
                                class="fs-5 text-gray-800">{{ !empty($doctorData->doctorUser->phone) ? $doctorData->doctorUser->region_code . $doctorData->doctorUser->phone : __('messages.common.n/a') }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                        ...
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            ...
                            @if (!empty($doctorData->doctorUser->blood_group))
                                <span
                                    class="text-{{ !empty($doctorData->doctorUser->blood_group) ? 'success' : 'danger' }}">
