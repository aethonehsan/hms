    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="is-validm">
                ...
                {{ Form::radio('gender', '0', true, ['class' => getLoggedInUser()->language == 'ar' ? 'form-check-input ms-10' : 'form-check-input me-10', 'id' => 'editDoctorMale']) }}
                &nbsp;
                <label class="form-label">{{ __('messages.user.female') }}</label>
                {{ Form::radio('gender', '1', false, ['class' => getLoggedInUser()->language == 'ar' ? 'form-check-input ms-10' : 'form-check-input me-10', 'id' => 'editDoctorFemale']) }}
            </span>
        </div>
    </div>
    <div class="col-md-3">
