            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{-- {{ Form::select('income_head', dump($incomeHeads), null, ['class' => 'form-select select2Selector', 'required', 'id' => 'incomeId', 'placeholder' => __('messages.incomes.select_income_head'), 'data-control' => 'select2']) }} --}}
                        <select class="form-select status-filter" id="incomeId" data-control="select2" name="income_head">
                            <option value="">{{ __('messages.incomes.select_income_head') }}</option>
