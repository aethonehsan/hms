                ...
                <div class="flex-grow-1">
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-wrap fs-6 mb-4  {{getCurrentLoginUserLanguageName() === 'ar' ? 'ps-2' : 'pe-2'}} }}">
                                <a href="mailto: {{$nurse->user->email}}"
                                   class="text-decoration-none d-flex align-items-center text-gray-400 text-hover-primary mb-2  {{getCurrentLoginUserLanguageName() === 'ar' ? 'ms-2' : 'me-2'}}">
                                    <span class="svg-icon svg-icon-4  {{getCurrentLoginUserLanguageName() === 'ar' ? 'ms-1' : 'me-1'}}">
                                ...
                                <sapn class="d-flex align-items-center text-gray-400 text-hover-primary  {{getCurrentLoginUserLanguageName() === 'ar' ? 'ms-5' : 'me-5'}} mb-2">
    ...
    <div class="mt-7 overflow-hidden">
        <ul class="nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap" id="myTab" role="tablist">
            <li class="nav-item position-relative {{ getLoggedInUser()->language == 'ar' ? 'ms-7' : 'me-7' }} mb-3" role="presentation">
                <a class="nav-link text-active-primary {{ getLoggedInUser()->language == 'ar' ? 'ms-6' : 'me-6' }} active" data-bs-toggle="tab" href="#aoverview">{{ __('messages.overview') }}</a>
            </li>
            <li class="nav-item position-relative {{ getLoggedInUser()->language == 'ar' ? 'ms-7' : 'me-7' }} mb-3" role="presentation">
