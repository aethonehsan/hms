                   ...
                   <div class="payment-div d-none">
                        <div class="row">
                            <div class="form-group col-sm-6 mb-5">
                                ...
                                {{-- {{ Form::select('payment_type', dump($payemnt_mode), null, ['class' => 'form-select','id' => 'appointmentCalenderPayment','placeholder'=>__('messages.ipd_payments.select_payment_mode'),'data-control' => 'select2']) }} --}}
                                <select class="form-select status-selector " id="appointmentCalenderPayment" data-control="select2" name="payment_type">
                                    <option value="">{{ __('messages.ipd_payments.select_payment_mode') }}</option>
                                    <option value="4">{{ __('messages.transaction_filter.cash') }}</option>
                                    <option value="6">{{ __('messages.transaction_filter.cheque') }}</option>
                                <select>
                            </div>
                            <div class="form-group col-sm-6 mb-5">
                    ...
                    <div align="{{getCurrentLoginUserLanguageName() == 'ar' ? 'right' : 'left'}}}" class="form-group col-sm-12 mb-5" id="appointmentSlotSection">
                        ...
                        <div class="color-information" align="{{getCurrentLoginUserLanguageName() == 'ar' ? 'right' : 'left'}}}" style="display: none">
                        ...
                        <div class="form-group col-sm-12 mb-5">
                            {{ Form::label('problem', __('messages.appointment.description').(':'),['class' =>getCurrentLoginUserLanguageName() == 'ar' ? 'form-label float-end' : 'form-label']) }}
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" class="btn btn-secondary {{ getLoggedInUser()->language == 'ar' ? 'me-2' : '' }}"
