    ...
    <div class="col-md-2">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::text('weight', null, ['class' => 'form-control', 'max' => '200', 'step' => '.01', 'placeholder' => __('messages.ipd_patient.weight')]) }}
            </div>
        </div>
    </div>
    <div class="col-md-2">
...
<div class="d-flex justify-content-end">
    ...
    <a href="{!! route('opd.patient.index') !!}" class="btn btn-secondary {{ getLoggedInUser()->language == 'ar' ? 'me-2' : '' }}">{!! __('messages.common.cancel') !!}</a>
</div>
