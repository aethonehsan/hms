<div class="tab-content" id="myTabContent">
    <div class="d-flex align-items-center py-1">
        ...
        <div
            class="d-flex align-items-center py-1 {{ getLoggedInUser()->language == 'ar' ? 'me-auto' : 'ms-auto' }}">
            <a class="btn btn-primary bed-type-edit-btn {{ getLoggedInUser()->language == 'ar' ? 'ms-2' : 'me-2' }}"
