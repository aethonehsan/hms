    ...
    <div class="col-md-6 appointment-payment d-none">
        <div class="form-group mb-5">
            ...
            @if (isset($appointment))
                {{ Form::select('payment_type', App\Models\Appointment::EDIT_PAYMENT_TYPES, null, ['class' => 'form-select', 'id' => 'appointmentPayment', 'placeholder' => __('messages.ipd_payments.select_payment_mode'), 'data-control' => 'select2']) }}
            @else
                {{ Form::select('payment_type', getAppointmentPaymentTypes(), null, ['class' => 'form-select', 'id' => 'appointmentPayment', 'placeholder' => __('messages.ipd_payments.select_payment_mode'), 'data-control' => 'select2']) }}
            @endif
        </div>
    </div>
    @if (!Auth::user()->hasRole('Patient'))
        ...
        <div class="form-group col-sm-6 mb-5">
            ...
            <br>
            <div class="form-check form-switch {{ getLoggedInUser()->language == 'ar' ? 'float-end' : '' }}">
                <input class="form-check-input w-35px h-20px" name="status" type="checkbox" value="1"
                    {{ isset($appointment) && $appointment->is_completed == 0 ? '' : 'checked' }}>
            </div>
        </div>
