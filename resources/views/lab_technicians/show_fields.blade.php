            ...
            <div class="col-xxl-5 col-12">
                <div class="d-sm-flex align-items-center mb-5 mb-xxl-0 text-center text-sm-start">
                    ...
                    <div class="ms-0 ms-sm-10 mt-5 mt-sm-0">
                        <span
                            class="badge bg-light-{{ $labTechnician->user->status === 1 ? 'success' : 'danger' }}">{{ $labTechnician->user->status === 1 ? __('messages.common.active') : __('messages.common.de_active') }}</span>
                        <h2><a href="#" class="text-decoration-none">{{ $labTechnician->user->full_name }}</a>
                        </h2>
                        ...
                        <span
                            ...
                            @endif
                            <span class="{{ getLoggedInUser()->language == 'ar' ? 'float-end' : 'float-start' }}">
                                ...
                                {{ empty($labTechnician->address->address1) && empty($labTechnician->address->address2) ? __('messages.common.n/a') : '' }}
...
<div class="mt-7 overflow-hidden">
    <ul class="nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap" id="myTab" role="tablist">
        ...
        <li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0" id="cases-tab" data-bs-toggle="tab" data-bs-target="#lpayrolls" type="button"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            ...
                            <span
                                class="fs-5 text-gray-800">{{ !empty($labTechnician->user->phone) ? $labTechnician->user->region_code . $labTechnician->user->phone : 'N/A' }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                        ...
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            ...
                            <p>
                                <span
                                    class="fs-6 badge bg-light-{{ !empty($labTechnician->user->blood_group) ? 'success' : 'danger' }}">{{ !empty($labTechnician->user->blood_group) ? $labTechnician->user->blood_group : __('messages.common.n/a') }}</span>
                            </p>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                        ...
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            ...
                            <span
                                class="fs-5 text-gray-800">{{ !empty($labTechnician->user->created_at) ? $labTechnician->user->created_at->diffForHumans() : __('messages.common.n/a') }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                class="pb-2 fs-5 text-gray-600">{{ __('messages.common.updated_at') . ':' }}</label>
                            <span
                                class="fs-5 text-gray-800">{{ !empty($labTechnician->user->updated_at) ? $labTechnician->user->updated_at->diffForHumans() : __('messages.common.n/a') }}</span>
                        </div>
                    </div>
                </div>
            </div>
