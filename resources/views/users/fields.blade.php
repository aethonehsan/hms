    ...
    <div class="col-lg-6">
        ...
        @if (!$isEdit)
            <div class="mb-5">
                ...
                <span class="required"></span>
                {{-- {{ Form::select('department_id', dump($role), null, ['class' => 'form-select', 'required', 'id' => 'userRole', 'placeholder' => __('messages.sms.select_role'), 'data-control' => 'select2']) }} --}}
                <select class="form-select status-selector " id="userRole" data-control="select2" name="department_id">
                    <option value="">{{ __('messages.sms.select_role') }}</option>
...
<div class="d-flex justify-content-end">
    ...
    <a href="{{ route('users.index') }}" class="btn btn-secondary {{ getLoggedInUser()->language == 'ar' ? 'me-2' : ''}}">{{ __('messages.common.cancel') }}</a>
</div>
