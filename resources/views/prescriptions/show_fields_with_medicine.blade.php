<div class="row">
    ...
    <div class="col-md-4 col-sm-6 co-12 mt-sm-0 mt-5">
        <div class="d-flex flex-row">
            <label for="name" class="pb-2 fs-5 text-gray-600 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.bill.patient_name') }}:</label>
            <span class="fs-5 text-gray-800">{{ $prescription['prescription']->patient->user->full_name }}</span>
        </div>
        <div class="d-flex flex-row">
            <label for="name" class="pb-2 fs-5 text-gray-600 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.bill.bill_date') }}:</label>
            <span
                class="fs-5 text-gray-800">{{ \Carbon\Carbon::parse($prescription['prescription']->created_at)->isoFormat('DD/MM/Y') }}</span>
        </div>
        <div class="d-flex flex-row">
            <label for="name" class="pb-2 fs-5 text-gray-600 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">Age:</label>
    ...
    @if (!empty($prescription['prescription']->food_allergies))
        <div class="col-md-4 col-sm-6 co-12">
            <h5 class="lh-lg text-gray-600 me-1 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">
    ...
    @if (!empty($prescription['prescription']->tendency_bleed))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.tendency_bleed') }}:
    ...
    @if (!empty($prescription['prescription']->heart_disease))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600  fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.heart_disease') }}:
    ...
    @if (!empty($prescription['prescription']->high_blood_pressure))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.high_blood_pressure') }}:
    ...
    @if (!empty($prescription['prescription']->diabetic))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.diabetic') }}:
    ...
    @if (!empty($prescription['prescription']->surgery))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.surgery') }}:
    ...
    @if (!empty($prescription['prescription']->accident))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.accident') }}:
    ...
    @if (!empty($prescription['prescription']->others))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.others') }}:
    ...
    @if (!empty($prescription['prescription']->medical_history))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.new_change.added_at') }}:
    ...
    @if (!empty($prescription['prescription']->current_medication))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.current_medication') }}:
    ...
    @if (!empty($prescription['prescription']->female_pregnancy))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.female_pregnancy') }}:
    ...
    @if (!empty($prescription['prescription']->breast_feeding))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.breast_feeding') }}:
    ...
    @if (!empty($prescription['prescription']->plus_rate))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.plus_rate') }}:
    ...
    @if (!empty($prescription['prescription']->temperature))
        <div class="col-md-4 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600  fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.temperature') }}:
    ...
    @if (!empty($prescription['prescription']->problem_description))
        <div class="col-md-6 col-sm-6 co-12">
            <h6 class="lh-lg text-gray-600 fs-5 {{getLoggedInUser()->language == 'ar' ? 'ms-1' : 'me-1'}}">{{ __('messages.prescription.problem_description') }}:
