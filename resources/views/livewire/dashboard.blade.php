<div>
    <div class="d-flex flex-column">
                    ...
                    <div class="col-xxl-3 col-xl-4 col-sm-6 widget">
                        <a href="{{ route('super.admin.hospitals.index') }}"
                            ...
                            <div
                                ...
                                <div
                                    class="text-white {{ getLoggedInUser()->language = 'ar' ? 'text-start' : 'text-end' }}">
        ...
        <div class="row mt-4">
            ...
            <div
                class="col-lg-6 col-xl-3 col-md-6 col-sm-6 {{ App::getLocale() == 'ar' ? 'me-auto' : 'ms-auto' }} ">
                <div class="form-group mb-3 d-flex">
                    <a href="javascript:void(0)"
                        class="btn btn-icon btn-primary me-5 ps-3 pe-2 {{ getLoggedInUser()->language = 'ar' ? 'ms-5' : '' }} "
                        title="Switch Chart">
                        <span class="m-0 text-center" id="changeChart">
                            <i class="fas fa-chart-bar fs-1 chart"></i>
                        </span>
                    </a>
                    <input class="form-control ps-3" autocomplete="off"
