<div class="ms-auto" wire:ignore>
    <div class="dropdown d-flex align-items-center me-md-5 {{ getLoggedInUser()->language == 'ar' ? 'ms-4' : 'me-4' }}">
        <button class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0" type="button"
            data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false" id="dropdownMenuButton1">
        ...
        <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuButton1">
            ...
            <div class="p-5">
                <div class="mb-10">
                    <label for="bed_assign_filter_status"
                    ...
                    <select class="form-select status-filter" id="bed_assign_filter_status" data-control="select2"
                        name="account_status">
