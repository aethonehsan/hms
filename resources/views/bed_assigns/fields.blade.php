    ...
    <div class="col-sm-6">
        <div class="mb-5 d-flex flex-column">
            ...
            <div class="form-check form-switch">
                <input
                    class="form-check-input w-35px h-20px switch-input is-active {{ getLoggedInUser()->language == 'ar' ? 'float-end' : 'float-start' }}"
                    name="status" type="checkbox" value="1"
                    {{ isset($bedAssign) && $bedAssign->status === 1 ? 'checked' : '' }}
