<div class="row">
    ...
    <div class="form-group col-12 mb-5 d-flex flex-column">
        {{ Form::label('status', __('messages.common.status') . ':', ['class' => 'form-label']) }}
        <div class="form-check form-switch d-flex">
            <input class="form-check-input w-35px h-20px is-active {{getLoggedInUser()->language=='ar'?'float-end':'float-start'}}" name="status" type="checkbox" value="1"
