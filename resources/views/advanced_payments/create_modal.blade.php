            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::select('patient_id', $patients, null, ['class' => 'form-select form-select-solid fw-bold', 'id' => 'advancedPaymentPatientId','placeholder' => __('messages.document.select_patient'), 'required','data-control' => 'select2']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
