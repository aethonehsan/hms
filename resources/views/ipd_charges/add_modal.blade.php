        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <select class="form-select status-selector " id="ipdChargeTypeId" data-control="select2" name="charge_type_id">
                        <option value="">{{ __('messages.charge_category.select_charge_type') }}</option>
