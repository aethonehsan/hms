            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{-- {{ Form::select('expense_head', dump($expenseHeads), null, ['class' => 'form-select', 'required', 'id' => 'expenseId', 'placeholder' => __('messages.expense.select_expense_head'), 'data-control' => 'select2']) }} --}}
                        <select class="form-select status-filter" id="expenseId" data-control="select2" name="expense_head">
                            <option value="">{{ __('messages.expense.select_expense_head') }}</option>
