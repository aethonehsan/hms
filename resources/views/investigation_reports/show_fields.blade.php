<div class="row">
    ...
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
        ...
        <p class="m-0">
            <span
                class="badge fs-6 bg-light-{{ $investigationReport->status == 1 ? 'success' : 'danger' }}">{{ $investigationReport->status == 1 ?  __('messages.investigation_report.solved') :  __('messages.investigation_report.not_solved') }}</span>
        </p>
    </div>
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
