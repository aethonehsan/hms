<div class="row gx-10 mb-5">
    ...
    <div class="col-md-4">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{-- {{ Form::select('status', dump($status), null, ['class' => 'form-select status-in-report', 'required', 'data-control' => 'select2']) }} --}}
            <select class="form-select status-selector status-in-report "  data-control="select2"
