    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <div class="d-flex align-items-center">
                <div class="form-check {{ getLoggedInUser()->language == 'ar' ? 'ms-5' : '' }}">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5 d-flex flex-column">
            ...
            <div class="form-check form-switch">
                <input
                    class="form-check-input is-active {{ getLoggedInUser()->language == 'ar' ? 'float-end' : 'float-start' }}"
                    name="status" type="checkbox" value="1" tabindex="8"
