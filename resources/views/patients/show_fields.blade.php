            ...
            <div class="col-xxl-5 col-12">
                <div class="d-sm-flex align-items-center mb-5 mb-xxl-0 text-center text-sm-start">
                    ...
                    <div class="ms-0 ms-sm-10 mt-5 mt-sm-0">
                        ...
                        <span class="d-flex align-items-start  {{ getLoggedInUser()->language == 'ar' ? 'ms-sm-5' : 'me-sm-5' }} mb-2 mt-2 text-gray-600 fs-5 justify-content-center justify-content-sm-center">
                            ...
                            @endif
                            <span class="{{ getLoggedInUser()->language == 'ar' ? 'text-end' : 'text-start' }}"> {{ !empty($data->address->address1) ? $data->address->address1 : '' }}{{ !empty($data->address->address2) ? !empty($data->address->address1) ? ',' : '' : '' }}
