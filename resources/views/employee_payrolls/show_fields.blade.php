                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
                            ...
                            <p class="m-0"><span
                                        class="badge bg-{{$employeePayroll->status == 0 ? 'danger' : 'success'}}">{{ ($employeePayroll->status == 0) ? __('messages.employee_payroll.not_paid') : __('messages.employee_payroll.paid') }}</span>
                            </p>
                        </div>
                        <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
