<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        ...
        <select class="form-select status-selector " id="EmployeePayrollMonth" data-control="select2" name="month">
            <option value="1">{{ __('messages.months.jan') }}</option>
            <option value="2">{{ __('messages.months.feb') }}</option>
            <option value="3">{{ __('messages.months.mar') }}</option>
            <option value="4">{{ __('messages.months.apr') }}</option>
            <option value="5">{{ __('messages.months.may') }}</option>
            <option value="6">{{ __('messages.months.jun') }}</option>
            <option value="7">{{ __('messages.months.jul') }}</option>
            <option value="8">{{ __('messages.months.aug') }}</option>
            <option value="9">{{ __('messages.months.sep') }}</option>
            <option value="10">{{ __('messages.months.oct') }}</option>
            <option value="11">{{ __('messages.months.nov') }}</option>
            <option value="12">{{ __('messages.months.dec') }}</option>
        </select>
