            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        <span class="text-danger error-msg d-none fw-400 fs-small mt-2" id="error-msg"></s </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6 mb-5">
                        ...
                        <div class="form-group col-sm-6 mb-5 d-flex flex-column">
                            ...
                            <div class="form-check form-switch form-check-custom">
                                <input class="form-check-input w-35px h-20px is-active {{getLoggedInUser()->language=='ar'?'float-end':'float-start'}}" name="status" type="checkbox"
