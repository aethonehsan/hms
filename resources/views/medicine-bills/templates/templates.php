...
<script id="medicineBillTemplate" type="text/x-jsrender">
    ...
    <td class="table__item-desc">
        ...
        <td>
            <input class="form-control medicineBillExpiryDate bg-white" placeholder="<?php echo __('messages.purchase_medicine.expiry_date') ?>" required name="expiry_date[]"  id="expiry_date{{:uniqueId}}" type="text">
        </td>
        <td>
