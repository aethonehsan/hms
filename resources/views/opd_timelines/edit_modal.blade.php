                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-0 d-flex flex-column">
                        ...
                        <div class="form-check form-switch">
                            <input
                                class="form-check-input w-35px h-20px switch-input {{ getLoggedInUser()->language == 'ar' ? 'float-end' : 'float-start' }}"
                                name="visible_to_person" id="editOpdTimelineVisibleToPerson" type="checkbox"
