...
<head>
    ...
    @endphp
    <title>@yield('title') |
        {{ getLoggedInUser()->hasRole('Super Admin') ? $superAdminSettingValue : getSettingValueByKey('app_name') }}
    </title>
    ...
    <script>
        ...
        // moment.locale(userCurrentLanguage);
    </script>
...
<body>
    ...
    <div class="d-flex flex-column flex-root vh-100">
        <div class="d-flex flex-row flex-column-fluid">
            ...
            <div
                class="d-flex flex-column flex-row-fluid {{ getLoggedInUser()->language == 'ar' ? 'wrapper-rtl' : 'wrapper' }}">
