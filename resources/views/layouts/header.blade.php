            ...
            @if (!is_null($isPatientIdCard))
                <li class="px-xxl-3 px-2">
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-trigger="hover"
                        ...
                        <button type="button" class="btn px-1 text-primary fs-3 show-patient-smart-card"
                            data-id="{{ $patientUniqueId }}" data-bs-toggle="modal" data-bs-target="#showSmartCardModal">
        ...
        <li class="px-xxl-3 px-2">
            <div class="dropdown custom-dropdown d-flex align-items-center py-4">
                ...
                <div class="dropdown-menu py-0 my-2" aria-labelledby="dropdownMenuButton1">
                    <div
                        class="border-bottom py-4 px-7 {{ getLoggedInUser()->language == 'ar' ? 'text-end' : 'text-start' }}">
                        ...
                        @if ($notificationCount > 0)
                            @foreach ($notifications as $notification)
                                <div class="d-flex position-relative mb-5 notification"
                                    ...
                                    <span
                                        class="text-primary fs-2 icon-label {{ getLoggedInUser()->language == 'ar' ? 'ms-5' : 'me-5' }}">
                                        <i class="{{ getNotificationIcon($notification->type) }}"></i>
                                    </span>
                                    <div>
                                        <a href="#"
                                            class="text-decoration-none {{ getLoggedInUser()->language == 'ar' ? 'text-end' : '' }}">
                                            <h5 class="text-gray-900 fs-6 mb-2">{{ $notification->title }}</h5>
                                        </a>
                                        <h6
                                            class="text-gray-600 fs-small fw-light mb-0 {{ getLoggedInUser()->language == 'ar' ? 'text-end' : '' }}">
            ...
            <div class="dropdown dropdown-transparent d-flex align-items-center py-4">
                ...
                <div class="dropdown-menu py-7 pb-4 my-2" aria-labelledby="dropdownMenuButton1">
                    ...
                    <ul class="pt-4 admin-ul">
                        <li class="p-0">
                            <a class="dropdown-item editProfile {{ getLoggedInUser()->language == 'ar' ? 'text-end' : '' }}"
                                data-id="{{ getLoggedInUserId() }}" href="javascript:void(0)">
                                <span
                                    class="dropdown-icon {{ getLoggedInUser()->language == 'ar' ? 'float-end ms-4' : 'me-4' }} text-gray-600 ">
                        ...
                        @if (getLoggedInUser()->hasRole('Admin'))
                            <li>
                                <a class="dropdown-item subscription_plan {{ getLoggedInUser()->language == 'ar' ? 'text-end' : '' }}"
                        ...
                        @if (session('impersonated_by'))
                            <li>
                                <a class="dropdown-item" href="{{ route('impersonate.userLogout') }}"
                                    data-turbo="false">
                                    <span
                                        class="dropdown-icon {{ getLoggedInUser()->language == 'ar' ? 'ms-4' : 'me-4' }} text-gray-600">
                        ...
                        @if (!session('impersonated_by'))
                            <li>
                                <button type="button"
                                    class="dropdown-item {{ getLoggedInUser()->language == 'ar' ? 'text-end' : '' }} "
                        ...
                        <li>
                            <button type="button"
                                class="dropdown-item {{ getLoggedInUser()->language == 'ar' ? 'text-end' : '' }}"
                                data-bs-toggle="modal" data-bs-target="#changeLanguageModal"
                                data-id="{{ getLoggedInUserId() }}">
                                <span
                                    class="dropdown-icon {{ getLoggedInUser()->language == 'ar' ? 'float-end ms-4' : 'me-4' }} text-gray-600">
                        ...
                        @if (!session('impersonated_by'))
                            <li>
                                ...
                                <a class="dropdown-item {{ getLoggedInUser()->language == 'ar' ? 'text-end' : '' }}"
                                    href="#"
