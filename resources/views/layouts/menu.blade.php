        ...
        @if (isFeatureAllowToUse('appointments.index', $subscriptionPlanFeaturesId))
            <li class="nav-item {{ Request::is('appointment*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('appointments.index') }}">
                    <span
                        class="aside-aside-menu-icon  {{ getLoggedInUser()->language == 'ar' ? 'ps-3 ps-3' : 'pe-3 pe-3' }}"><i
...
@if (Auth::user()->email_verified_at != null)
    @role('Doctor')
        ...
        @if ($diagnosisDoctorMGT)
            <li
                class="nav-item {{ Request::is('patient-diagnosis-report*', 'diagnosis-categories*', 'patient-diagnosis-test*') ? 'active' : '' }}">
        ...
        @module('Notice Boards', $modules)
            ...
            @if (isFeatureAllowToUse('live.consultation.index', $subscriptionPlanFeaturesId))
                ...
                @if ($liveConsultation)
                    <li
                        class="nav-item {{ Request::is('live-consultation*', 'live-meeting*', 'connect-google-calendar') ? 'active' : '' }}">
                        <a class="nav-link  d-flex align-items-center py-3 " href="{{ $liveConsultation }}">
                            <span class="aside-menu-icon pe-3"><i class="fa fa-video"></i></span>
                            <span class="aside-menu-title">{{ __('messages.live_consultations') }}</span>
                            <span class="d-none">{{ __('messages.live_meetings') }}</span>
    ...
    @role('Accountant')
        ...
        @module('My Payrolls', $modules)
            <li class="nav-item {{ Request::is('employee/payroll') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('payroll') }}">
                    <span class="aside-menu-icon pe-3"><i class="fas fa-chart-pie"></i></span>
                    <span class="{{ getLoggedInUser()->language == 'ar' ? 'me-2' : '' }}">{{ __('messages.my_payrolls') }}</span>
                </a>
            </li>
        @endmodule
