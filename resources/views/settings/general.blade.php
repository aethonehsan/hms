        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-6 mb-5 hospitalPhone">
                    ...
                    <span class="required"></span>
                    <br>
                    {{ Form::tel('hospital_phone', $settings['hospital_phone'], ['class' => 'form-control text-start', 'id' => 'phoneNumber', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'required']) }}
            ...
            <div class="row">
                    ...
                    <div class="image-input image-input-outline">
                        ...
                        <div class="image-picker">
                            <div class="image previewImage" id="logoPreviewImage"
                                {{ $style }}="{{ $background }} url({{ $settings['app_logo'] ? $settings['app_logo'] : asset('hms-saas-logo.png') }})">
                            </div>
                ...
                <div class="form-group col-sm-6 mb-5">
                    <div class="d-block">
                        ...
                        <span class="required"></span>
                        <span data-bs-toggle="tooltip" id="planTooltip" data-placement="top"
                    ...
                    <div class="image-input image-input-outline">
                        ...
                        <div class="image-picker">
                            <div class="image previewImage" id="previewImage"
                                {{ $style }}="{{ $background }} url({{ $settings['favicon'] ? $settings['favicon'] : asset('web/img/hms-saas-favicon.ico') }})">
                            </div>
                            <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                ...
                <hr>
                <div class="form-group col-lg-6 col-md-6 d-flex justify-content-start mb-3">
                    ...
                    <span
                        class="form-label {{ getLoggedInUser()->language == 'ar' ? 'me-2' : '' }}">{{ __('messages.setting.enable_google_reCAPTCHA') }}</span>
                </div>
                <div class="form-group col-md-6 col-lg-6 mb-3">
                    <div class="d-flex align-items-center">
                        <span class="form-label">{{ __('messages.open_ai.opne_ai') . ' :' }}</span>
                ...
                <div class="row">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        {{ Form::reset(__('messages.common.cancel'), ['class' => getLoggedInUser()->language == 'ar' ? 'btn btn-secondary me-2' : 'btn btn-secondary ms-2']) }}
                    </div>
                </div>
                {{ Form::close() }}
            </div>
