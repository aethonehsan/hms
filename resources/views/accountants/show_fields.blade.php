            ...
            <div class="col-xxl-5 col-12">
                <div class="d-sm-flex align-items-center mb-5 mb-xxl-0 text-center text-sm-start">
                    ...
                    <div class="ms-0 ms-sm-10 mt-5 mt-sm-0">
                        <span
                            class="badge bg-light-{{ $accountant->user->status === 1 ? 'success' : 'danger' }} mb-2">{{ $accountant->user->status === 1 ? __('messages.common.active') : __('messages.common.de_active') }}</span>
                        ...
                        <span
                            ...
                            @if (
                                ...
                                <i class="fa-solid fa-location-dot text-gray-600 {{ getLoggedInUser()->language == 'ar' ? 'ms-3' : 'me-3' }} mt-1"></i>
                            @endif
            ...
            <div class="col-xxl-7 col-12">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 col-sm-6 col-12">
                        <div class="border rounded-10 p-5 h-100">
                            <h2 class="text-primary mb-3">
                                {{ !empty($doctorData->appointments) ? $doctorData->appointments->count() : 0 }}</h2>
...
<div class="mt-7 overflow-hidden">
    <ul class="nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap" id="myTab" role="tablist">
        <li class="nav-item position-relative {{ getLoggedInUser()->language == 'ar' ? 'ms-7' : 'me-7' }} mb-3" role="presentation">
            <a class="nav-link text-active-primary {{ getLoggedInUser()->language == 'ar' ? 'ms-6' : 'me-6' }} active" data-bs-toggle="tab"
                href="#aoverview">{{ __('messages.overview') }}</a>
        </li>
        <li class="nav-item position-relative {{ getLoggedInUser()->language == 'ar' ? 'ms-7' : 'me-7' }} mb-3" role="presentation">
            <a class="nav-link text-active-primary {{ getLoggedInUser()->language == 'ar' ? 'ms-6' : 'me-6' }}" data-bs-toggle="tab"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                ...
                                <div class="col-lg-8">
                                    <span
                                        class="fs-5 text-gray-800">{{ !empty($accountant->user->phone) ? $accountant->user->region_code . $accountant->user->phone : __('messages.common.n/a') }}</span>
                                </div>
                            </div>
                            <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            ...
                            <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                ...
                                <div class="col-lg-8">
                                    <span
                                        class="fs-6 stext-{{ !empty($accountant->user->blood_group) ? 'success' : 'danger' }}">{{ !empty($accountant->user->blood_group) ? $accountant->user->blood_group : __('messages.common.n/a') }}</span>
                                </div>
                            </div>
                            <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
