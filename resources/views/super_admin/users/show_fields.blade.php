            ...
            <div class="col-xxl-5 col-12">
                <div class="d-sm-flex align-items-center mb-5 mb-xxl-0 text-center text-sm-start">
                    ...
                    <div class="ms-0 ms-sm-10 mt-5 mt-sm-0">
                        <span
                            class="badge bg-light-{{ $users['hospital']->status === 1 ? 'success' : 'danger' }} mb-2">{{ $users['hospital']->status === 1 ? __('messages.common.active') : __('messages.common.de_active') }}</span>
...
<div class="mt-7">
    <ul class="nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap" id="myTab" role="tablist">
        ...
        <li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0" id="cases-tab" data-bs-toggle="tab" data-bs-target="#husers" type="button"
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            ...
                            <span
                                class="fs-5 text-gray-800">{{ !empty($users['hospital']->email) ? $users['hospital']->email : __('messages.common.n/a') }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                class="pb-2 fs-5 text-gray-600">{{ __('messages.employee_payroll.role') . ':' }}</label>
                            <span
                                class="fs-5 text-gray-800">{{ !empty($users['hospital']->roles[0]->name) ? $users['hospital']->roles[0]->name : __('messages.common.n/a') }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                class="pb-2 fs-5 text-gray-600">{{ __('messages.user.phone') . ':' }}</label>
                            <span
                                class="fs-5 text-gray-800">{{ !empty($users['hospital']->phone) ? $users['hospital']->phone : __('messages.common.n/a') }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                class="pb-2 fs-5 text-gray-600">{{ __('messages.common.created_at') . ':' }}</label>
                            <span
                                class="fs-5 text-gray-800">{{ !empty($users['hospital']->created_at) ? $users['hospital']->created_at->diffForHumans() : __('messages.common.n/a') }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                class="pb-2 fs-5 text-gray-600">{{ __('messages.common.updated_at') . ':' }}</label>
                            <span
                                class="fs-5 text-gray-800">{{ !empty($users['hospital']->updated_at) ? $users['hospital']->updated_at->diffForHumans() : __('messages.common.n/a') }}</span>
                        </div>
                    </div>
                </div>
            </div>
