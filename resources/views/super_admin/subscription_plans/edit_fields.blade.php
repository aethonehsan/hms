    ...
    <div class="col-md-4 mb-5">
        <div class="form-group">
            ...
            <select class="form-select status-selector " id="planType" data-control="select2" name="frequency">
                <option @selected($subscriptionPlan->frequency == 1) value="1">{{ __('messages.employee_payroll.month') }}</option>
                <option @selected($subscriptionPlan->frequency == 2) value="2">{{ __('messages.employee_payroll.year') }}</option>
            </select>
        </div>
    </div>
