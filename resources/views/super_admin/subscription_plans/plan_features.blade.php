...
<div class="row">
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
        <label class="form-check form-switch form-check-custom form-check-solid {{getLoggedInUser()->language == 'ar' ? 'float-start' : 'float-end'}}">
            <input class="form-check-input cursor-pointer" type="checkbox" name="select_all" id="selectAllPlanFeatures"
                value="0" />
...
<div class="row">
    @foreach ($planFeatures as $planFeature)
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12 mb-5">
            <label class="form-check form-switch form-check-custom" style="display: inline-block">
                <input class="form-check-input feature {{ $planFeature->name == 'SMS / Mail' ? 'sms-limit' : '' }} "
                    type="checkbox" name="plan_feature[]" value="{{ $planFeature->id }}"
