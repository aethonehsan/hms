    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-2 col-md-2 mb-5 d-flex flex-column">
                        {{ Form::label('active', __('messages.common.status') . ':', ['class' => 'form-label']) }}
                        <div class="form-check form-switch ">
                            <input class="form-check-input  h-20px is-active {{getLoggedInUser()->language=='ar' ? 'float-end' : 'float-start'}}" name="is_active" type="checkbox"
