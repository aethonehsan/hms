<div class="row">
    ...
    <div class="form-group col-sm-6 mb-5">
        ...
        <select class="form-select status-selector " id="vehicleType" data-control="select2" name="vehicle_type">
            <option @selected($ambulance->vehicle_type == 2) value="2">{{ __('messages.ambulance.owned') }}</option>
            <option @selected($ambulance->vehicle_type == 1) value="1">{{ __('messages.ambulance.contractual') }}</option>
        </select>
    </div>
