<div class="row">
    ...
    <select class="form-select status-selector " id="ambulancesVehicleType" data-control="select2" name="vehicle_type">
        <option value="2">{{ __('messages.ambulance.owned') }}</option>
        <option value="1">{{ __('messages.ambulance.contractual') }}</option>
    </select>
