...
@section('section')
    <div class="card border-0">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        ...
                        <span class="required"></span>
                        {{ Form::text('default_country_code', null, ['class' => 'form-control', 'placeholder' => __('messages.common.default_country_code'), 'id' => 'defaultCountryData']) }}
                ...
                <div class="form-group col-md-6">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-switch fv-row mb-3 d-flex flex-column ">
                                <input tabindex="11" name="enable_google_recaptcha"
                                    class="form-check-input w-35px h-20px is-active {{ getLoggedInUser()->language == 'ar' ? 'float-end' : 'float-start' }}"
                                    value="1"
                ...
                <div class="captcha-div d-none col-12">
                    <div class="row">
                        <div class="form-group col-sm-6 mb-5">
                            ...
                            {{ Form::text('google_captcha_key', isset($settings['google_captcha_key']) ? $settings['google_captcha_key'] : null, ['class' => 'form-control', 'id' => 'captchaKey', 'placeholder' => __('messages.new_change.captcha_key')]) }}

                        </div>
                        <div class="form-group col-sm-6 mb-5">
                            {{ Form::label('google_captcha_secret', __('messages.new_change.captcha_secret') . ':', ['class' => 'form-label']) }}
                            {{ Form::text('google_captcha_secret', isset($settings['google_captcha_secret']) ? $settings['google_captcha_secret'] : null, ['class' => 'form-control', 'id' => 'captchaSecret', 'placeholder' => __('messages.new_change.captcha_secret')]) }}
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="{{ getLoggedInUser()->language == 'ar' ? 'float-start' : 'float-end' }}">
                {{ Form::submit(__('messages.common.save'), ['class' => getLoggedInUser()->language == 'ar' ? 'btn btn-primary ms-2' : 'btn btn-primary me-2']) }}
