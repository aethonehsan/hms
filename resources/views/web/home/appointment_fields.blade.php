...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6 web-appointment-payment d-none">
        <div class="form-group mb-5">
            ...
            {{ Form::select('payment_type', getAppointmentPaymentTypes(), null, ['class' => 'selectized', 'id' => 'webAppointmentPayment', 'placeholder' => __('messages.ipd_payments.select_payment_mode')]) }}
        </div>
    </div>
    <div class="col-lg-12">
        <div class="appointment-form__input-block">
