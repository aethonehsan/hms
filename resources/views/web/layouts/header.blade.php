        ...
        <div class="row align-items-center">
            <div class="col-lg-1 col-4">
                <a href="{{ route('front', $user->username) }}" data-turbo="false" class="header-logo">
                    <img src="{{ asset($hospitalSettingValue['app_logo']['value']) }}" alt="Infy HMS" class="img-fluid" />
                </a>
            </div>
                        ...
                        <ul class="navbar-nav align-items-center py-2 py-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#"
                                    ...
                                    <i class="fa-solid fa-angle-down {{ App::getLocale() == 'ar' ? 'me-1' : 'ms-1' }}"></i>
                                </a>
                                <ul class="nav submenu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ Route::is('privacy-policy') ? 'active' : '' }} {{ App::getLocale() == 'ar' ? 'me-4' : '' }}"
                                            ...
                                            @if ($imageKey == $key)
                                                <li class="nav-item languageSelection"
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        <img class="country-flag {{ App::getLocale() == 'ar' ? 'ms-2 me-4' : 'me-2' }}"
                        ...
                        <div class="text-xl-end header-btn-grp ms-xl-3">
                            @if (Auth::user())
                                @role('Admin')
                                    <a href="{{ route('dashboard') }}" data-turbo="false"
                                        class="btn btn-success mb-3 mb-xl-0 {{ App::getLocale() == 'ar' ? 'ms-2' : 'me-2' }}"
                                        data-turbo="false">
                            ...
                            @else
                                <a href="{{ route('login') }}" data-turbo="false"
                                    class="btn btn-success btn-sm me-xxl-3 mb-3 rounded-2 mb-xl-0 {{ App::getLocale() == 'ar' ? 'ms-2' : 'me-2' }}"
                                    data-turbo="false">
