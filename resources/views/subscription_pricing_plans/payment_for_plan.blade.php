                    ...
                    @if ($transction)
                        <div class="row justify-content-center">
                            <div
                                ...
                                <div class="mt-5 me-3  stripePayment proceed-to-payment">
                                    <button type="button"
                                ...
                                <div class="mt-5 me-3  paypalPayment proceed-to-payment d-none">
                                    <button type="button"
                                ...
                                <div class="mt-5 me-3  razorPayPayment proceed-to-razor-pay-payment d-none">
                                    <button type="button"
                                ...
                                <div class="mt-5 me-3  cashPayment proceed-cash-payment d-none">
                                ...
                                @if (strtolower($subscriptionsPricingPlan->currency) == 'inr')
                                    <div class="mt-5 me-3  paytmPayment proceed-to-payment d-none">
                                        <button type="button"
                                ...
                                @endif
                                @if (strtolower($subscriptionsPricingPlan->currency) == 'inr')
                                    <div class="mt-5 me-3  phonePePayment proceed-to-phonepe-payment d-none">
                                        <button type="button"
                                ...
                                @endif
                                <div class="mt-5 me-3  flutterWavePayment proceed-to-flutterWave-payment d-none">
                                    <button type="button"
                                ...
                                @if (in_array(strtoupper(getCurrentCurrency()), $currency))
                                    <div class="mt-5 me-3  paystackPayment proceed-to-payment d-none">
                                        <button type="button"
                    ...
                    @else
                        <div class="row justify-content-center">
                            <div
                                ...
                                <div
                                    class="mt-5 me-3  stripePayment proceed-to-payment {{ $newPlan['amountToPay'] <= 0 ? '' : 'd-none' }}">
                                    <button type="button"
                                                    ...
                                                    <div class="d-block">
                                                        <div class="image-picker ">
                                                            ...
                                                            <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                                                ...
                                                                data-bs-original-title="{{ __('messages.choose_attachment') }}">
                                                                <label>
