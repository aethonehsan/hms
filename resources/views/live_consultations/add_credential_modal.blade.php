    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <a href="https://developers.zoom.us/docs/integrations/create/" class="text-start text-decoration-none pt-1 pb-1" target="_blank">{{ __('messages.live_consultation.how_to_generate_Oauth_credentials').' ?' }}</a>
                </div>
