    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-7">
                    ...
                    <input class="form-control" id="pfNewPassword" type="password" name="password" required
                        placeholder="{{ __('messages.change_password.new_password') }}">
                    <div class="invalid-feedback">
                ...
                <div>
                    ...
                    <span class="required"></span>
                    <input class="form-control" id="pfNewConfirmPassword" type="password" name="password_confirmation"
                        required placeholder="{{ __('messages.change_password.confirm_password') }}">
                    <div class="invalid-feedback">
                        {{ $errors->first('password') }}
                    </div>
                </div>
            ...
            <div class="modal-footer pt-0">
                {{ Form::button(__('messages.common.save'), ['type' => 'submit', 'class' => getLoggedInUser()->language == 'ar' ? 'btn btn-primary m-3' : 'btn btn-primary m-0', 'id' => 'btnPrPasswordEditSave', 'data-loading-text' => "<span class='spinner-border spinner-border-sm'></span> Processing..."]) }}
