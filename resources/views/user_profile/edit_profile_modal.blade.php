    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 fv-row mb-7">
                        <div class="form-group mb-5">
                            ...
                            <span class="text-success d-none fw-400 fs-small mt-2 valid-msg" id="validMsg">✓ &nbsp;
            ...
            <div class="modal-footer pt-0">
                {{ Form::button(__('messages.common.save'), ['type' => 'submit', 'class' => getLoggedInUser()->language == 'ar' ? 'btn btn-primary m-3' : 'btn btn-primary m-0', 'id' => 'btnPrEditSave', 'data-loading-text' => "<span class='spinner-border spinner-border-sm'></span> Processing..."]) }}
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer pt-0">
                ...
                <button type="button"
                    class="btn btn-secondary my-0 me-0 {{ getLoggedInUser()->language == 'ar' ? 'me-5' : 'ms-5' }}"
