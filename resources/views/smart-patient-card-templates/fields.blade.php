    <div class="row">
        <div class="col-xl-4 col-md-3">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-group {{ getLoggedInUser()->language == 'ar' ? 'mb-10' : 'mb-5' }}">
                        {{ Form::label('show_email', __('messages.lunch_break.show_email') . ':', ['class' => 'form-label ']) }}
                        <br>
                        <div class="form-check form-switch">
                            <input name="show_email" class="form-check-input patient-email" value="1"
                                type="checkbox" id="showEmail" checked>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
                ...
                <div class="col-md-8">
                    <div class="form-group {{ getLoggedInUser()->language == 'ar' ? 'mb-10' : 'mb-5' }}">
                        ...
                        <br>
                        <div class="form-check form-switch">
                            <input name="show_blood_group" class="form-check-input is-active" value="1"
                                type="checkbox" id="showBloodGroup" checked>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
            ...
            <div class="d-flex align-items-start justify-content-center">
                <div class="patient-card shadow-lg">
                    <div class="patient-card-header d-flex align-items-center custom-card-header">
                        <div class="flex-1 d-flex align-items-center me-3">
                            <div class="patient-card-logo {{ getLoggedInUser()->language == 'ar' ? 'ms-4' : 'me-4' }}">
                                <img src="{{ asset(getLogoUrl()) }}" alt="logo" class="h-100 img-fluid" />
                            </div>
                            <h4 class="text-white mb-0 fw-bold">{{ getAppName() }}</h4>
                        </div>
                        <div class="flex-1 {{ getLoggedInUser()->language == 'ar' ? 'text-start' : 'text-end' }}">
                            <address class="text-white fs-12 mb-0">
                                <p class="mb-0">
                                    {{ getSettingValueByKey('hospital_address') }}
                                </p>
                        ...
                        <div class="d-flex flex-sm-nowrap flex-wrap justify-content-between">
                            <div class="">
                                <div class="d-flex flex-sm-nowrap flex-wrap mb-3">
                                    <div
                                        class="image image-circle image-small {{ getLoggedInUser()->language == 'ar' ? 'ms-3' : 'me-3' }}">
                                        <a>
                                            <div>
                                                <img src="{{ asset('assets/images/profile.png') }}" alt=""
                                                    class="user-img rounded-circle image">
                                    ...
                                    <div class="">
                                        <table
                                            class="table table-borderless patient-desc mb-0 {{ getLoggedInUser()->language == 'ar' ? 'ms-8' : '' }}">
                                            <tr id="cardName">
                                ...
                                <div class="d-flex address-text {{ getLoggedInUser()->language == 'ar' ? 'ms-5' : 'me-5' }}"
                                    id="patientAddress">
                                    <div class="mb-0 {{ getLoggedInUser()->language == 'ar' ? 'ms-5' : 'me-3' }}">
                                        {{ __('messages.common.address') }}:</div>
                                    <div>
                                        <address class="mb-0">
                                            D.No.1 Street name Address line 2 line 3
                                        </address>
                            ...
                            <div class="w-25">
                                <div class="text-end mb-5">
                                    <div
                                        class="qr-code {{ getLoggedInUser()->language == 'ar' ? 'me-auto' : 'ms-auto' }}">
                                        {!! QrCode::size(90)->generate('https://hms-saas.test/h/sims/patient-details/700XYs') !!}
                                    </div>
                                    <h6 class="text-primary mt-5 {{ getLoggedInUser()->language == 'ar' ? 'text-start' : 'text-end' }}"
                                        id="patientUniqueID">
        ...
        <div class="d-flex justify-content-start">
            <div class="d-flex ">
                ...
                <a href="{{ route('patient-smart-card-templates.index') }}"
                    class="btn btn-secondary {{ getLoggedInUser()->language == 'ar' ? 'me-2' : 'ms-2' }}">{{ __('messages.common.cancel') }}</a>
            </div>
        </div>
    </div>
