                ...
                <div class="patient-card-body bg-white">
                    <div class="d-flex flex-sm-nowrap flex-wrap justify-content-between">
                        <div class="">
                            ...
                            <div class="d-flex address-text {{ getLoggedInUser()->language == 'ar' ? 'ms-5' : 'me-5' }} {{ $patientSmartCardTemplate->show_address == true ? '' : 'd-none' }}"
                                id="patientAddress">
                        ...
                        <div class="w-25">
                            <div class="text-end mb-5">
                                ...
                                <h6 class="text-primary {{ getLoggedInUser()->language == 'ar' ? 'text-start' : 'text-end' }} mt-5 {{ $patientSmartCardTemplate->show_patient_unique_id == true ? '' : 'd-none' }}"
