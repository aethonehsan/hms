    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.success) {
                ...
                $('#patient_phone').text(result.data.phone ? result.data.phone : Lang.get('js.n/a'))
                ...
                $('#description').text(result.data.description ? result.data.description : Lang.get('js.n/a'))
                $('#patientStatus').empty()
