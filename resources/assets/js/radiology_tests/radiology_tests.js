    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.success) {
                ...
                $('#radiologyTestSubCategory').text(result.data.subcategory ? result.data.subcategory : Lang.get('js.n/a'))
                $('#radiologyTestReportDays').text(result.data.report_days ? result.data.report_days : Lang.get('js.n/a'));
