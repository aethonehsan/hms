    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.success) {
                ...
                $('#showMedicineSideEffects').text(result.data.side_effects ? result.data.side_effects : Lang.get('js.n/a'))
                ...
                $('#showMedicineDescription').text(result.data.description ? result.data.description : Lang.get('js.n/a'))
